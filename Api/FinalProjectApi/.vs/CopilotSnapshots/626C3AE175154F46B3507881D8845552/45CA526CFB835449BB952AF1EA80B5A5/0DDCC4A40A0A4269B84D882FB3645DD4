(() => {
  ...
  if (typeof Swiper !== 'undefined') {
    ...
    document.querySelector('#hero') && new Swiper('#hero', {
      loop: true,
      autoplay: { delay: 5000 },
      effect: 'fade',
      navigation: {
    ...
    document.querySelector('.tour-slider') && new Swiper('.tour-slider', {
      loop: true,
      autoplay: { delay: 4000 },
      slidesPerView: 2,
      spaceBetween: 20,
    ...
    document.querySelector('.testimonials-swiper') && new Swiper('.testimonials-swiper', {
      loop: true,
      autoplay: { delay: 4000 },
      navigation: {

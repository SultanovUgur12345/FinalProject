...
public class FeatureController : AdminBaseController
{
    ...
    public FeatureController(IFeatureApiService service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> Create(FeatureCreateVM dto)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, FeatureEditVM dto)
    {
        if (!ModelState.IsValid)
            return View(dto);
